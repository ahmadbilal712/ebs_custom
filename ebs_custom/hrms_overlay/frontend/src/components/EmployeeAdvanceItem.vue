<template>
	...
	>
		...
		<template #right>
			<Badge variant="outline" :theme="colorMap[status] || 'orange'" :label="__(status, null, 'Employee Advance')" size="md" />
...
const colorMap = {
	...
	"Pending Accounts Officer": "orange",
	"Pending CEO": "orange",
	"Approved By Account Officer": "green",
	"Rejected By Accounts Officer": "red",
}
